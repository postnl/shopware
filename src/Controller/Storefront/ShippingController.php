...
class ShippingController extends StorefrontController
{
    ...
    #[Route(path: '/widget/checkout/postnl/shipping-date', name: 'frontend.checkout.postnl.shipping-date', options: ['seo' => false], defaults: ['XmlHttpRequest' => true], methods: ['POST'])]
