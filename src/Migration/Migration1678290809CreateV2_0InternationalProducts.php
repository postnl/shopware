...
class Migration1678290809CreateV2_0InternationalProducts extends ProductMigration
{
    ...
    public function update(Connection $connection): void
    {
        $products = [
            [
                'id'                                       => Uuid::fromHexToBytes(Defaults::PRODUCT_SHIPPING_NL_EU_4907),
            ...
            [
                'id'                                       => Uuid::fromHexToBytes(Defaults::PRODUCT_SHIPPING_BE_EU_4907),
                'product_code_delivery'                    => '4907',
                'source_zone'                              => Zone::BE,
                'destination_zone'                         => Zone::EU,
                'delivery_type'                            => DeliveryType::SHIPMENT,
            ...
            [
                'id'                                       => Uuid::fromHexToBytes(Defaults::PRODUCT_SHIPPING_NL_GLOBAL_4909),
            ...
            [
                'id'                                       => Uuid::fromHexToBytes(Defaults::PRODUCT_SHIPPING_BE_GLOBAL_4909),
                'product_code_delivery'                    => '4909',
                'source_zone'                              => Zone::BE,
                'destination_zone'                         => Zone::GLOBAL,
                'delivery_type'                            => DeliveryType::SHIPMENT,
        ...
        $this->deprecateProducts($connection, [
            Defaults::PRODUCT_SHIPPING_NL_EU_4952 => Defaults::PRODUCT_SHIPPING_NL_EU_4907,
            Defaults::PRODUCT_SHIPPING_BE_EU_4952 => Defaults::PRODUCT_SHIPPING_BE_EU_4907,
            Defaults::PRODUCT_SHIPPING_NL_GLOBAL_4945 => Defaults::PRODUCT_SHIPPING_NL_GLOBAL_4909,
            Defaults::PRODUCT_SHIPPING_BE_GLOBAL_4945 => Defaults::PRODUCT_SHIPPING_BE_GLOBAL_4909,
        ]);
    }
