...
class Migration1678710150CreateV2_0InternationalMailboxProducts extends ProductMigration
{
    ...
    public function update(Connection $connection): void
    {
        $products = [
            ...
            // EU Package
            [
                'id'                                           => Uuid::fromHexToBytes(Defaults::PRODUCT_PARCEL_NL_EU_6405),
                'product_code_delivery'                        => '6405',
                'source_zone'                                  => Zone::NL,
                'destination_zone'                             => Zone::EU,
                'delivery_type'                                => DeliveryType::PARCEL,
                ProductDefinition::STOR_HOME_ALONE             => null,
                ProductDefinition::STOR_RETURN_IF_NOT_HOME     => null,
            ...
            [
                'id'                                           => Uuid::fromHexToBytes(Defaults::PRODUCT_PARCEL_NL_EU_6350),
            ...
            [
                'id'                                           => Uuid::fromHexToBytes(Defaults::PRODUCT_PARCEL_NL_EU_6906),
            ...
            // GLOBAL Package
            [
                'id'                                           => Uuid::fromHexToBytes(Defaults::PRODUCT_PARCEL_NL_GLOBAL_6405),
                'product_code_delivery'                        => '6405',
                'source_zone'                                  => Zone::NL,
                'destination_zone'                             => Zone::GLOBAL,
                'delivery_type'                                => DeliveryType::PARCEL,
            ...
            [
                'id'                                           => Uuid::fromHexToBytes(Defaults::PRODUCT_PARCEL_NL_GLOBAL_6350),
                'product_code_delivery'                        => '6350',
                'source_zone'                                  => Zone::NL,
                'destination_zone'                             => Zone::GLOBAL,
                'delivery_type'                                => DeliveryType::PARCEL,
            ...
            [
                'id'                                           => Uuid::fromHexToBytes(Defaults::PRODUCT_PARCEL_NL_GLOBAL_6906),
                'product_code_delivery'                        => '6906',
                'source_zone'                                  => Zone::NL,
                'destination_zone'                             => Zone::GLOBAL,
                'delivery_type'                                => DeliveryType::PARCEL,
