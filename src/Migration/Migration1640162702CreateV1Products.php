    ...
    public function update(Connection $connection): void
    {
        $products = [
            [
                ...
                ProductCodeConfigDefinition::STOR_HOME_ALONE => false,
                ProductCodeConfigDefinition::STOR_RETURN_IF_NOT_HOME => false,
                ProductCodeConfigDefinition::STOR_INSURANCE => false,
                ProductCodeConfigDefinition::STOR_SIGNATURE => false,
                ProductCodeConfigDefinition::STOR_AGE_CHECK => false,
                ProductCodeConfigDefinition::STOR_NOTIFICATION => null,
            ...
            [
                ...
                'destination_zone' => Zone::NL,
                'delivery_type' => DeliveryType::SHIPMENT,
                ProductCodeConfigDefinition::STOR_HOME_ALONE => true,
                ProductCodeConfigDefinition::STOR_RETURN_IF_NOT_HOME => false,
                ProductCodeConfigDefinition::STOR_INSURANCE => false,
                ProductCodeConfigDefinition::STOR_SIGNATURE => false,
                ProductCodeConfigDefinition::STOR_AGE_CHECK => false,
            ...
            [
                ...
                'delivery_type' => DeliveryType::SHIPMENT,
                ProductCodeConfigDefinition::STOR_HOME_ALONE => false,
                ProductCodeConfigDefinition::STOR_RETURN_IF_NOT_HOME => true,
                ProductCodeConfigDefinition::STOR_INSURANCE => false,
                ProductCodeConfigDefinition::STOR_SIGNATURE => false,
                ProductCodeConfigDefinition::STOR_AGE_CHECK => false,
                ProductCodeConfigDefinition::STOR_NOTIFICATION => null,
            ...
            [
                ...
                ProductCodeConfigDefinition::STOR_HOME_ALONE => false,
                ProductCodeConfigDefinition::STOR_RETURN_IF_NOT_HOME => false,
                ProductCodeConfigDefinition::STOR_INSURANCE => true,
                ProductCodeConfigDefinition::STOR_SIGNATURE => false,
                ProductCodeConfigDefinition::STOR_AGE_CHECK => false,
                ProductCodeConfigDefinition::STOR_NOTIFICATION => null,
                'created_at' => (new \DateTime())->format(ShopwareDefaults::STORAGE_DATE_TIME_FORMAT)
            ...
            [
                ...
                ProductCodeConfigDefinition::STOR_RETURN_IF_NOT_HOME => false,
                ProductCodeConfigDefinition::STOR_INSURANCE => false,
                ProductCodeConfigDefinition::STOR_SIGNATURE => true,
                ProductCodeConfigDefinition::STOR_AGE_CHECK => false,
                ProductCodeConfigDefinition::STOR_NOTIFICATION => null,
                'created_at' => (new \DateTime())->format(ShopwareDefaults::STORAGE_DATE_TIME_FORMAT)
            ],
            ...
            [
                ...
                ProductCodeConfigDefinition::STOR_HOME_ALONE => null,
                ProductCodeConfigDefinition::STOR_RETURN_IF_NOT_HOME => null,
                ProductCodeConfigDefinition::STOR_INSURANCE => false,
                ProductCodeConfigDefinition::STOR_SIGNATURE => true,
                ProductCodeConfigDefinition::STOR_AGE_CHECK => false,
                ProductCodeConfigDefinition::STOR_NOTIFICATION => false,
                'created_at' => (new \DateTime())->format(ShopwareDefaults::STORAGE_DATE_TIME_FORMAT)
            ],
            [
            ...
            [
                ...
                ProductCodeConfigDefinition::STOR_SIGNATURE => true,
                ProductCodeConfigDefinition::STOR_AGE_CHECK => false,
                ProductCodeConfigDefinition::STOR_NOTIFICATION => true,
                'created_at' => (new \DateTime())->format(ShopwareDefaults::STORAGE_DATE_TIME_FORMAT)
            ],
            [
            ...
            [
                ...
                ProductCodeConfigDefinition::STOR_HOME_ALONE => null,
                ProductCodeConfigDefinition::STOR_RETURN_IF_NOT_HOME => null,
                ProductCodeConfigDefinition::STOR_INSURANCE => null,
                ProductCodeConfigDefinition::STOR_SIGNATURE => null,
                ProductCodeConfigDefinition::STOR_AGE_CHECK => null,
                ProductCodeConfigDefinition::STOR_NOTIFICATION => null,
                'created_at' => (new \DateTime())->format(ShopwareDefaults::STORAGE_DATE_TIME_FORMAT)
            ],
            [
