    ...
    public function update(Connection $connection): void
    {
        $products = [
            [
                ...
                ProductDefinition::STOR_HOME_ALONE => false,
                ProductDefinition::STOR_RETURN_IF_NOT_HOME => false,
                ProductDefinition::STOR_INSURANCE => false,
                ProductDefinition::STOR_SIGNATURE => false,
                ProductDefinition::STOR_AGE_CHECK => false,
            ...
            [
                ...
                'destination_zone' => Zone::NL,
                'delivery_type' => DeliveryType::SHIPMENT,
                ProductDefinition::STOR_HOME_ALONE => true,
                ProductDefinition::STOR_RETURN_IF_NOT_HOME => false,
                ProductDefinition::STOR_INSURANCE => false,
                ProductDefinition::STOR_SIGNATURE => false,
                ProductDefinition::STOR_AGE_CHECK => false,
            ...
            [
                ...
                'delivery_type' => DeliveryType::SHIPMENT,
                ProductDefinition::STOR_HOME_ALONE => false,
                ProductDefinition::STOR_RETURN_IF_NOT_HOME => true,
                ProductDefinition::STOR_INSURANCE => false,
                ProductDefinition::STOR_SIGNATURE => false,
                ProductDefinition::STOR_AGE_CHECK => false,
                ProductDefinition::STOR_NOTIFICATION => null,
            ...
            [
                ...
                ProductDefinition::STOR_HOME_ALONE => false,
                ProductDefinition::STOR_RETURN_IF_NOT_HOME => false,
                ProductDefinition::STOR_INSURANCE => true,
                ProductDefinition::STOR_SIGNATURE => false,
                ProductDefinition::STOR_AGE_CHECK => false,
                ProductDefinition::STOR_NOTIFICATION => null,
                'created_at' => (new \DateTime())->format(ShopwareDefaults::STORAGE_DATE_TIME_FORMAT)
            ...
            [
                ...
                ProductDefinition::STOR_RETURN_IF_NOT_HOME => false,
                ProductDefinition::STOR_INSURANCE => false,
                ProductDefinition::STOR_SIGNATURE => true,
                ProductDefinition::STOR_AGE_CHECK => false,
                ProductDefinition::STOR_NOTIFICATION => null,
                'created_at' => (new \DateTime())->format(ShopwareDefaults::STORAGE_DATE_TIME_FORMAT)
            ],
            ...
            [
                ...
                ProductDefinition::STOR_SIGNATURE => true,
                ProductDefinition::STOR_AGE_CHECK => false,
                ProductDefinition::STOR_NOTIFICATION => false,
                'created_at' => (new \DateTime())->format(ShopwareDefaults::STORAGE_DATE_TIME_FORMAT)
            ],
            [
            ...
            [
                ...
                ProductDefinition::STOR_SIGNATURE => true,
                ProductDefinition::STOR_AGE_CHECK => false,
                ProductDefinition::STOR_NOTIFICATION => true,
                'created_at' => (new \DateTime())->format(ShopwareDefaults::STORAGE_DATE_TIME_FORMAT)
            ],
            [
